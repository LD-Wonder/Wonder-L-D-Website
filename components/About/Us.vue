                    ...
                    >
                      ...
                      >
                        <svg
                          ...
                          class="mx-auto object-cover rounded-full h-10 w-10 hover:fill-red-500"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        >
                          <path
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg
                        class="mx-auto object-cover rounded-full h-10 w-10 hover:fill-blue-500"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                      >
                  ...
                  <div class="flex-1 pl-1 md:mr-16">
                    <div class="font-medium text-white">@WelcomeAdvert</div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg
                        class="mx-auto object-cover rounded-full h-10 w-10 hover:fill-pink-500"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                      >
                  ...
                  <div class="flex-1 pl-1 md:mr-16">
                    <div class="font-medium text-white">@rapidms</div>
                  ...
                  >
                    <a href="/join" target="_blank" class="block relative">
                      <svg
                        width="71"
                        height="55"
                        class="mx-auto object-cover rounded-sm h-10 w-10 hover:fill-indigo-500"
                        viewBox="0 0 71 55"
                        fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg"
                      >
