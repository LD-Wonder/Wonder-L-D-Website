export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'og:url', content: 'https://rapid-services.org' },
      {
        name: 'og:image',
        content: 'https://imgs.mrfluffycloud.xyz/Logo-Bolt-Resized.png',
      },
      { name: 'og:title', content: 'Rapid Services' },
      { name: 'og:site_name', content: 'Rapid Services' },
      {
        name: 'og:description',
        content: 'Rapid Services, a place to promote your stuff like no other!',
      },
  ...
  plugins: [{ src: '~/plugins/number-animation.js', ssr: false }],
